    ...
    <div class="mainWrapper">
      <div class="container mainContainer"><!-- Content inside this div -->
        ...
        <div class="col-lg-7 col-md-8 col-xs-12 contentContainer">
          ...
          <div class="container">
            <div class="row">
              <p><b>Directora:</b>  Dra. Astrid Motura</p>
              <p class="justify">
                ...
                La Direcci&oacute;n de la Escuela espera a todos los alumnos, socios y docentes en los Ateneos de este ciclo 2018 para que cada encuentro sea
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    <td style="vertical-align:middle;">ABRIL</td>
                    <td style="vertical-align:middle;">13</td>
                    <td>Los diarios cl&iacute;nicos de Hahnemann<br>(Investigaci&oacute;n hist&oacute;rica. Dres Mercado y Campanelli)</td>
                    <!--<td>Grupo Investigaci&oacute;n Hist&oacute;rica: Dres. Mercado y Campanelli</td>-->
                  </tr>
                  <tr>
                    <td>MAYO</td>
                    <td>04</td>
                    <td>Proyecci&oacute;n de la pel&iacute;cula "Just One Drop"</td>
                    <!--<td>C&aacute;tedra Dr. &Aacute;ngel Minotti</td>-->
                  </tr>
                  <tr>
                    <td>JUNIO</td>
                    <td>01</td>
                    <td>C&aacute;tedra Dr. Minotti - D&iacute;az Campos</td>
                    <!--<td>C&aacute;tedra Dr. Juan Carlos Pellegrino</td>-->
                  </tr>
                  <tr>
                    <td>JULIO</td>
                    <td>13</td>
                    <td>C&aacute;tedra de Veterinaria (Dra. Patricia Douer)</td>
                    <!--<td>C&aacute;tedra Dra. Eva Blaho</td>-->
                  </tr>
                  <tr>
                    <td>AGOSTO</td>
                    <td>03</td>
                    <td>C&aacute;tedra Dra. Moreno Galaud</td>
