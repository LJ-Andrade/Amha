    ...
    <div class="mainWrapper">
      <div class="container mainContainer"><!-- Content inside this div -->
        ...
        <div class="col-lg-9 col-md-12 col-xs-12 contentContainer">
          <div class="sectionTits"><h1>Acerca de la A.M.H.A</h1>
          <h3>Autoridades</h3><br></div>

            <!-- Comisi&oacute;n Directiva -->
            <div class="row wow zoomIn fadeIn">
              <div class="card-deck-wrapper innerContentContainer">
                <div class="card-deck">
                  <div class="card">
            ...
            </div><!-- /Row - Comisi&oacute;n Directiva -->
